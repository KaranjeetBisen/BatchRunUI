...
function calOBJ(name, title, field, form, onChangeFunc) {
    this.name = name;
    this.title = title;
    this.field = field;
    this.formName = form;
...
function addCalendar(name, title, field, form, onChangeFunc) {
    cals[cals.length] = new calOBJ(name, title, field, form, onChangeFunc);
}
...
function showCal(name) {
    ...
    if (currentCal != null && currentCal.form != null && currentCal.form[currentCal.field]) {
        var calRE = getFormat();
        // Initialize the Bootstrap Datepicker on the input field
        $('#' + currentCal.field).datepicker({
        ...
        if (!hasCal) {
            $('#' + currentCal.field).datepicker('show');
        }
    } else {
        if (currentCal == null) {
...
function pickDate(d) {
    ...
    if (currentCal.onChangeFunc != "") {
        eval(currentCal.onChangeFunc + "();");
    }
}
// ------
